...
def evaluate_agent(cfg: ProjectConfig, eval_inputs_path: str) -> mlflow.models.EvaluationResult:  # type: ignore
    ...
    def predict_fn(question: str) -> str:
        ...
        result = agent.predict(request)  # type: ignore
        return result.output[-1].content  # type: ignore

    return mlflow.genai.evaluate(  # type: ignore
