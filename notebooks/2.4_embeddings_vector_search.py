...
vs_manager = VectorSearchManager(
    config=cfg, endpoint_name=cfg.vector_search_endpoint, embedding_model=cfg.embedding_endpoint
)
...
results = index.similarity_search(query_text=query, columns=["text", "id", "title", "arxiv_id"], num_results=5)
