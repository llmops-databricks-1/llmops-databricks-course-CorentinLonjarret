...
# MAGIC %md
# MAGIC # Lecture 1.2: Foundation Models Overview
# MAGIC
...
host = w.config.host
token = w.tokens.create(lifetime_seconds=600).token_value
...
# MAGIC Check [Databricks Pricing](https://www.databricks.com/product/pricing) for current rates.
# MAGIC
