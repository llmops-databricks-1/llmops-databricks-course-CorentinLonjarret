...
# Check if schema exists, if not log an error and raise an exception
try:
...
papers_df.select("title", "published", "arxiv_id").orderBy("published", ascending=False).show(5, truncate=60)
