...
def rewrite_query(original_query: str) -> list[str]:
    ...
    prompt = (
        "Given this search query, generate 3 alternative phrasings that would "
        f"help retrieve relevant information:\n\nOriginal query: {original_query}\n\n"
    ...
    response = client.chat.completions.create(
        model=MODEL_NAME, messages=[{"role": "user", "content": prompt}], max_tokens=200, temperature=0.7
    )
